# SHARED BRIEF — give this to Claude Design ONCE (it retains it across all SMA figures)

_The per-figure prompts assume everything below and do not repeat it._
